                ...
                <CardContent className="space-y-6">
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-muted-foreground break-all">
                            ...
                            此外，这个项目本身是 <a href="https://studio.firebase.google.com/" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Firebase Studio</a> 构建的。开源地址：<a href="https://github.com/gengyj16/DepthWeaver" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">https://github.com/gengyj16/DepthWeaver</a>
                        </p>
                    </div>
                </CardContent>
            </Card>
